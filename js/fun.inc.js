...
function navnow(dom,part2,part3,none){
	...
	var dl=li.next("http://www.metinfo.cn/demo/metv5/templates/default/images/js/dd.sub");
	if(none)dl.hide();
	if(part2.next("http://www.metinfo.cn/demo/metv5/templates/default/images/js/dd.sub").length>0)part2.next("http://www.metinfo.cn/demo/metv5/templates/default/images/js/dd.sub").show();
	if(part3.length>0)part3.parent('http://www.metinfo.cn/demo/metv5/templates/default/images/js/dd.sub').show();
	li.bind('click',function(){
		var fdl=$(this).next("http://www.metinfo.cn/demo/metv5/templates/default/images/js/dd.sub");
		if(fdl.length>0){
